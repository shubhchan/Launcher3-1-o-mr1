...
public class BadgeRenderer {
    ...
    private static final float CHAR_SIZE_PERCENTAGE = 0.10f;
    ...
    private static boolean BOTTOM_BADGE = false;
    /*
    ...
    */
    ...
    public void draw(Canvas canvas, IconPalette palette, @Nullable BadgeInfo badgeInfo,
        ...
        //boolean isBOTTOM_BADGE = false;
        int badgeCenterX = iconBounds.right - width / 2;
        int badgeCenterY = iconBounds.top + mSize / 2;

        BOTTOM_BADGE = Utilities.getPrefs(mContext).getBoolean("pref_bottombadge", false);
        if(BOTTOM_BADGE == true)
        {
            badgeCenterY = iconBounds.bottom - mSize / 2;
        }
       /* if(isBOTTOM_BADGE == true)
        {
